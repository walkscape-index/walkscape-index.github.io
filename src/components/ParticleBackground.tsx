        ...
        const handleMouseMove = (e: MouseEvent) => {
            ...
            if (lastMouseX !== 0 && lastMouseY !== 0) {
                ...
                if (distanceSinceLastFootprint > 35) {
                    ...
                    const offsetAngle = angle + (isRightFoot ? Math.PI / 2 : -Math.PI / 2);
